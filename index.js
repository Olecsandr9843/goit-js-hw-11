/* empty css                      */import{a as f,S as h,i as a}from"./assets/vendor-ChKhXQjG.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&l(o)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();const m="51422808-09cfa7462dc66736a72b15f6d",y="https://pixabay.com/api/",g=i=>f.get(y,{params:{key:m,q:i,image_type:"photo",orientation:"horizontal",safesearch:!0}}).then(r=>r.data.hits),n=document.querySelector(".gallery"),d=document.querySelector(".loader-box"),L=new h(".gallery-item a",{captionsData:"alt",captionDelay:250}),b=i=>{const r=i.map(({webformatURL:s,largeImageURL:l,tags:e,likes:t,views:o,comments:p,downloads:u})=>`
